...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mvt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14056&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mvt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mvt` can be installed with:

```
conda install mvt
```

It is possible to list all of the versions of `mvt` available on your platform with:
